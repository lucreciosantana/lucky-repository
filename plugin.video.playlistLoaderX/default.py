...
AddonID = 'plugin.video.playlistLoaderX'
...
addon_data_dir = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.playlistLoaderX/data" ).decode("utf-8"), AddonID)
